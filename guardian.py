...
class TruthMachine:
    ...
    async def verify_shadow(self, code_map: Dict[str, str]) -> Tuple[bool, str, Dict[str, Any]]:
        ...
        # 4. Duplicate definition + mid-file import check — catches append mutations
        # Track class scope so __init__ in different classes is not flagged
        ...
        for path, file_content in code_map.items():
            ...
            top_defs: dict = {}      # top-level def/class names -> line
            class_methods: dict = {} # "ClassName.method" -> line
            current_class = None
            past_first = False
            for i, line in enumerate(lines, 1):
                ...
                if tm2:
                    ...
                    top_defs[name] = i
                    past_first = True
                # Class methods — scope to current class
